...
class Game
	...
	def room_1
		puts "\nYou awake to find yourself in a dark, musty room. In this room are an empty FLAGON, a suspicious looking HAYSTACK, and a sharp ROCK. 
	...
	def room_4
		...
		when 'DRUNK BRAYAN'
			...
			password = gets.chomp
				if password == "I want to be X-Tina when I grow up."
					you_win
